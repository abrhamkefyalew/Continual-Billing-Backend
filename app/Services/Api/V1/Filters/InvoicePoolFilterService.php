...
class InvoicePoolFilterService
{

    /**
     * Applies filters to the InvoicePool query based on request input.
     *
     ...
     */
    public static function applyInvoicePoolFilter(Builder $builder, Request $request): Builder
    {
        $filters = [
            'asset_pool_id_search' => 'asset_pool_id',
        ...
        if (isset($request['status_search']) && filled($request['status_search'])) {
            ...
            // if (!in_array($statusSearch, \App\Models\InvoicePool::allowedTypes(), true)) {
