...
class Payer extends Authenticatable implements HasMedia
{
    ...
    {
        $url = 'https://adiamat.com/payers/reset-password/?token='.$token; // modify this url // depending on your route
    ...
    public function setPhoneNumberAttribute($value)
    {
        ...
        if ($this->where('phone_number', $formattedPhoneNumber)->exists()) {
            ...
            $validator = Validator::make(['phone_number' => $formattedPhoneNumber], [
                // 'phone_number' => 'unique:payers',
                'phone_number' => Rule::unique('payers')->ignore($this->id),
            ]);
    ...
    // constants // payer constants
    public const PAYER_PROFILE_PICTURE = 'PAYER_PROFILE_PICTURE';
    public const PAYER_ID_FRONT_PICTURE = 'PAYER_ID_FRONT_PICTURE';
    public const PAYER_ID_BACK_PICTURE = 'PAYER_ID_BACK_PICTURE';
}
